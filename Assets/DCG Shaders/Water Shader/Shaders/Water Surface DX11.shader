        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float Tessellation(TessVertex v){
                    float TessellationLevel = lerp(clamp(_MaxTessellation,1,1024),1.0,saturate(pow((distance(mul(unity_ObjectToWorld, v.vertex).rgb,_WorldSpaceCameraPos)/150.0),0.5)));
